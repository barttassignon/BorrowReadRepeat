...
public class HashSetBoek {
    public static void main(String[] args) {
        ...
        //Boeken aanmaken
        Boek b1=new Boek(101, 9789401611039,"Zon","Lucinda Riley","Xander Uitgevers B.V.", "Nederlands", 732, 13-2-2020, 24.99, "RIRO",0, 2);
        Boek b2=new Boek(102,9789026343339, "In hechtenis", "Nicci French", "Ambo|Anthos", "Nederlands", 437, 7-4-2020, 22.99, "FRRO", 1, 5);
